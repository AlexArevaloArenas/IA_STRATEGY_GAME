...
namespace FischlWorks_FogWar
{
    ...
    public class csFogWar : MonoBehaviour
    {
        ...
        public class FogRevealer
        {
            ...
            [SerializeField]
            private int sightAngle = 0;
            public int _SightRange => sightRange;
            public int _SightAngle => sightAngle;
        ...
        //NEW
        // Gameplay features we will use with other game modules
        [NonSerialized] 
        ...
        {
            Debug.Log("Añadir!!");
            fogRevealers.Add(new FogRevealer(unit.transform, (int) unit.viewRange, false));
