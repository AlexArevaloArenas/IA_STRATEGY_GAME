...
public class AgentAction
{
    ...
    public HashSet<AgentBelief> Preconditions { get; } = new(); //Things we need to believe to start
    public HashSet<AgentBelief> Effects { get; } = new(); //Things we believe to be true when we finish
